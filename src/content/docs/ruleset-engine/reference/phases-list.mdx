...
For Cloudflare Access, the row above refers to Access application checking. Access enforcement and handling run in later internal phases, after Bulk Redirects.
